...
## SnapUI Inspector:
This is my favorite part about this addon for Unity. It is where all of the heavy lifting comes in play. This window can: edit the theme files I have custom created for this project, update the UI of the objects without the scene to be running, support for buttons, a full area of tools for editing text,
creating templates of items you have allready made so you can easily drop another into the scene, alignment tools for the position of the selected UI object, and a debug view to see the size and pos relitive to its parent.
